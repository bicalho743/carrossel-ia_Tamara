...
5. Para cada imagem, escolha uma referência de estrutura e documente em:
   ...
   - `referencias.instrucao_referencia`
...
- lógica de layout;
- ritmo de blocos;
- proporção entre título e corpo;
- estilo de hierarquia;
- tipo de grid;
- presença ou ausência de imagem humana;
- densidade de texto.

Não use a referência para:
...
Sempre fechar o arquivo com:

```markdown
## Sumario de Referencias Por Slide

- Slide 1 = sem imagem humana
- Slide 2 = referência humana em [arquivo], se houver
